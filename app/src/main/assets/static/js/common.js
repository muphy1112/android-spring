...
(function (w, _) {
    ...
    util.file = util.file || {};
    _.extend(util.file, {
        downloadXls: function (filename, content) {
...
(function (w, _) {
    ...
    _.extend(util.table, {
        ...
        create: function (selector, data, head, cft) {
            ...
            let content = this.getContent(data, head, cft);
            selector.innerHTML = '';
            selector.appendChild(content);
            return this;
        },
        getContent: function (data, head, cft) {
            data = data || [];
            ...
            let table = this.getTable(data, head);
        ...
        getTable: function (data, head) {
            ...
            table.className = (table.className + " table").trim();
            this.table = table;
            return table;
        },
        ...
        getThead: function (head, rowfun, colfun) {
            ...
            thead.className = (thead.className + " thead").trim();
            return thead;
        },
        getTbody: function (data, head, rowfun, colfun) {
            ...
            tbody.className = (tbody.className + " tbody").trim();
            return tbody;
        },
        getBodyRow: function (row, head, rownum, rowspan, rowfun, colfun) {
            ...
            if (row) {
                ...
                let td = this.getCol('td', row || '没有数据！', rownum, 1, rowspan, head.length, function () {
                    colfun && colfun.call(this, this);
