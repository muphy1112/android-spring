...
public class ValidateUtils {
    ...
    public static boolean isHexString(String hex, int minLen) {
        if (StringUtils.isEmpty(hex) || hex.length() < minLen) {
            return false;
        }
    ...
    public static boolean isHexString(String hex) {
        ...
        return hex.matches("^([\\da-fA-F]{2}\\s*)*[\\da-fA-F]{2}$");
    }

    @Remind("优化")
    public static boolean isHexStringWithParameter(String hex) {
        if (StringUtils.isEmpty(hex)) {
            return false;
        }
        if (hex.matches("^([\\da-fA-FX]{2}\\s+)*[\\da-fA-FX]{2}$") && !hex.matches(".*[^X ]X.*") && !hex.matches(".*X[^X ].*")) {
            return (hex.replaceAll(" ", "").length() - hex.replaceAll("[\\* ]", "").length()) % 2 == 0;
        }
        return false;
    }
     ...
     * @see #isUrl
     */
    public static boolean isServerPort(String url) {
        String regex = "^(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5]):([0-9]|[1-9]\\d|[1-9]\\d{2}|[1-9]\\d{3}|[1-5]\\d{4}|6[0-4]\\d{3}|65[0-4]\\d{2}|655[0-2]\\d|6553[0-5])$";
    ...
    public static boolean isIp(String url) {
        String regex = "^(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])$";
        return match(regex, url);
    }
     ...
     * @return
     */
    public static boolean isPort(String url) {
